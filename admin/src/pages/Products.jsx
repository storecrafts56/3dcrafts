...
import { Plus, Search, ListFilter as Filter, CreditCard as Edit, Trash2, Star } from 'lucide-react';
...
const Products = () => {
  ...
  const toggleFeatured = async (product) => {
    try {
      await productsAPI.update(product._id, { ...product, featured: !product.featured });
      fetchProducts();
    } catch (error) {
